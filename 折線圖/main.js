...
//日期處理
const parseDate = string => d3.timeParse('%Y-%m-%d')(string);//Data utilities
...
function prepareLineCharData(data){
   //取得發行年份
...
const lineChartData = prepareLineCharData(movieClean);
